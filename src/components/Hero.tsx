      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 grid-rows-[auto_1fr] gap-y-16 pt-16 md:pt-16 lg:grid-cols-12 lg:gap-y-16 lg:px-3 lg:pb-20 lg:pt-10 xl:pt-0 xl:pb-32">
        ...
        <div className="bg-white pt-16 lg:col-span-7 lg:bg-transparent lg:pl-16 lg:pt-0 xl:pl-20">
          <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
            <h1>
              <span className="font-display text-2xl font-extrabold text-slate-900 sm:text-4xl">The Aqida (Beliefs / Creed)</span><br />
              <span className="text-2xl text-slate-900 sm:text-2xl"> of </span>
              <span className="font-display text-2xl font-extrabold text-slate-900 sm:text-4xl">Ahl al-Sunnah wa’l-Jamaa’ah</span>
            </h1>
            <p className="mt-4 text-2xl text-slate-600">
              The text of Imam Tahawi&apos;s Aqida is widely accepted as a sound and reliable source of the
              Aqida of Ahl al-Sunnah wa&apos;l-Jamaa&apos;ah and represents what the majority of Muslims
              have believed for over 1,400 years and continue to believe today.
            </p>
